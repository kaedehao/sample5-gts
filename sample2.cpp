...
void Sample2::init(){
    ...
    //in this Sample2 we have 2 shadow and radiance
    ...
    optix::Program ray_gen_program = m_context->createProgramFromPTXFile("ptx/sample5_generated_pinhole_camera.cu.ptx","pinhole_camera");
    ...
    optix::Program miss_program = m_context->createProgramFromPTXFile("ptx/sample5_generated_constantbg.cu.ptx","miss");
    //set our miss colour
...
//----------------------------------------------------------------------------------------------------------------------
optix::Geometry Sample2::createGeomtry(){
    ...
    box_intersection_program = m_context->createProgramFromPTXFile("ptx/sample5_generated_box.cu.ptx", "box_intersect");
    box_bounding_box_program = m_context->createProgramFromPTXFile("ptx/sample5_generated_box.cu.ptx", "box_bounds");
...
//----------------------------------------------------------------------------------------------------------------------
optix::Material Sample2::createMaterial(){
    //create our closest hit and any hit programs
    optix::Program closest_hit_program = m_context->createProgramFromPTXFile("ptx/sample5_generated_phong.cu.ptx","closest_hit_radiance");
    optix::Program any_hit_program = m_context->createProgramFromPTXFile("ptx/sample5_generated_phong.cu.ptx","any_hit_shadow");
...
//----------------------------------------------------------------------------------------------------------------------
void Sample2::createGeometryInstances(optix::Geometry _box, optix::Material _material){

    // our transforms
    //optix::Transform transforms[m_numBoxes];
    optix::Transform transform;
    // geomtry group of geomtrygroups.... groupception if you will
    optix::Group top_level_group = m_context->createGroup();
...
QImage Sample2::trace(){
    ...
    img.save("Sample2.png","PNG");
    std::cout<<"sample2 image saved!"<<std::endl;
